...
class CommentsRepositoryImplIntegrationTest {
    ...
    private static final Long EXPECTED_COMMENTS_COUNT = 4L;
    ...
    @Test
    void getById() {
        var result = repository.findById(EXISTING_COMMENT_ID).orElse(null);
    ...
    void create() {
        ...
        var result = repository.save(comment);
    ...
    void update() {
        var genre = repository.findById(EXISTING_COMMENT_ID)
                .map(value -> {
