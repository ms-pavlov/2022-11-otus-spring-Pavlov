...
public class QuestionSourceImplTest {
    ...
    public void testFindAll() {
        QuestionDataSource dataSource = new QuestionSourceImpl(Map.of("path", "./test.csv"));
    ...
    public void testFileNotFound() {
        QuestionDataSource dataSource = new QuestionSourceImpl(Map.of("path", "/testFileNotFound.csv"));
        assertThrows(RuntimeException.class, dataSource::getQuestions);
    }

    @Test
    public void testEmptyFilePath() {
        QuestionDataSource dataSource = new QuestionSourceImpl(Map.of("path", ""));
        assertThrows(RuntimeException.class, dataSource::getQuestions);
    }
