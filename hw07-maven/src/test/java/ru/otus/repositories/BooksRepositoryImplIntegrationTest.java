...
class BooksRepositoryImplIntegrationTest {
    ...
    void getByName() {
        var result = repository.findByName(EXISTING_BOOKS_NAME);
    ...
    void getById() {
        var result = repository.findById(EXISTING_BOOKS_ID);
    ...
    void update() {
        var book = repository.findById(EXISTING_BOOKS_ID)
                .orElse(null);
        ...
        var result = repository.findById(book.getId()).orElse(null);
